...
<head>
	...
	<meta name="author" content="xiaoz.me mod by baiyue.one" />
                ...
                <div class = "layui-col-lg12">
                    ...
                    <div class = "layui-hide-xs">
                        <ul class="layui-nav menu" lay-filter="">
                            ...
                            <li class="layui-nav-item"><a href="https://baiyue.one/about.html" target = "_blank"><i class="layui-icon">&#xe60b;</i> 关于</a></li>
                        </ul>
                    </div>
